 ...
 * @author mengbo
 */
public class Fix6PropertySection extends AbstractPropertySection {
	 ...
	 * Constructor
	 */
	public Fix6PropertySection(String propertyType) {
		this.setPropertySourceProvider(new FixPropertySourceProvider(propertyType));
	}
