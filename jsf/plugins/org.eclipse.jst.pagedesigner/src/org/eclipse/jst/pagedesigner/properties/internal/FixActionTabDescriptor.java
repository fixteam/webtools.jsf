 ...
 */
public class FixActionTabDescriptor extends AbstractTabDescriptor {
	 ...
	 * Constructor
	 */
	public FixActionTabDescriptor(){
		super();
		descriptors = new Vector<ISectionDescriptor>(1);
		descriptors.add(new Fix6SectionDescriptor(ConstantVariable.fixAction_en));
//		getSectionDescriptors().add(new MDQuickEditTabSectionDescriptor());
	...
	public String getCategory() {
		return ConstantVariable.fixAction_en;
	}
	...
	public String getLabel() {
		return ConstantVariable.fixAction_cn;
	}
