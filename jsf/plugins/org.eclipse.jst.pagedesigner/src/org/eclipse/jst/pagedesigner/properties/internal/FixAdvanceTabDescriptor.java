 ...
 */
public class FixAdvanceTabDescriptor extends AbstractTabDescriptor {
	 ...
	 * Constructor
	 */
	public FixAdvanceTabDescriptor(){
		super();
		descriptors = new Vector<ISectionDescriptor>(1);
		descriptors.add(new Fix6SectionDescriptor(ConstantVariable.fixAdvance_en));
//		getSectionDescriptors().add(new MDQuickEditTabSectionDescriptor());
	...
	public String getCategory() {
		return ConstantVariable.fixAdvance_en;
	}
	...
	public String getLabel() {
		return ConstantVariable.fixAdvance_cn;
	}
