 ...
 */
public class FixNormalTabDescriptor extends AbstractTabDescriptor {
	 ...
	 * Constructor
	 */
	public FixNormalTabDescriptor(){
		super();
		descriptors = new Vector<ISectionDescriptor>(1);
		descriptors.add(new Fix6SectionDescriptor(ConstantVariable.fixNormal_en));
//		getSectionDescriptors().add(new MDQuickEditTabSectionDescriptor());
	...
	public String getCategory() {
		return ConstantVariable.fixNormal_en;
	}
	...
	public String getLabel() {
		return ConstantVariable.fixNormal_cn;
	}
