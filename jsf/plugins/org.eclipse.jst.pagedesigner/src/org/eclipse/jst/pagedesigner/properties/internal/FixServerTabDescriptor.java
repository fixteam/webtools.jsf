 ...
 */
public class FixServerTabDescriptor extends AbstractTabDescriptor {
	 ...
	 * Constructor
	 */
	public FixServerTabDescriptor(){
		super();
		descriptors = new Vector<ISectionDescriptor>(1);
		descriptors.add(new Fix6SectionDescriptor(ConstantVariable.fixServer_en));
//		getSectionDescriptors().add(new MDQuickEditTabSectionDescriptor());
	...
	public String getCategory() {
		return ConstantVariable.fixServer_en;
	}
	...
	public String getLabel() {
		return ConstantVariable.fixServer_cn;
	}
